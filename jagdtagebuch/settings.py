...
SECRET_KEY = 'django-insecure-jagdtagebuch-change-this-in-production-xyz123'
...
MIDDLEWARE = [
    'jagdtagebuch.middleware.ScriptNameMiddleware',
...
ROOT_URLCONF = 'jagdtagebuch.urls'
...
WSGI_APPLICATION = 'jagdtagebuch.wsgi.application'
